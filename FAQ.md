...
Deepgram (`nova-3`), OpenAI Realtime (`gpt-transcribe` or `gpt-live-transcribe`), ElevenLabs Realtime (`scribe_v2_realtime`), and AssemblyAI (Universal-3.6 Pro, Universal-3.5 Pro, or Universal Streaming English/multilingual).
