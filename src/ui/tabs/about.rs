...
pub fn render_about(app: &JarvisApp, ui: &mut egui::Ui, _ctx: &egui::Context) {
    ...
    egui::ScrollArea::vertical()
        ...
        .show(ui, |ui| {
            ...
            ui.label(
                egui::RichText::new("Jarvis \u{2014} Voice Dictation")
                    .size(13.0)
                    .strong()
                    .color(TEXT_COLOR),
            );
...
pub fn render_faq(_app: &JarvisApp, ui: &mut egui::Ui, _ctx: &egui::Context) {
    egui::ScrollArea::vertical()
        .max_height(ui.available_height().max(260.0))
        .show(ui, |ui| {
            ui.set_min_width(ui.available_width());
