...
fn render_system_placeholder(ui: &mut egui::Ui) {
    ...
    let rows = [
        ...
        ("go back", "In Chrome/Edge/Firefox only: navigate browser back."),
        ("address", "In Chrome/Edge/Firefox only: focus the browser address bar."),
        ("scroll up", "In Chrome/Edge/Firefox only: scroll up a little."),
        ("scroll down", "In Chrome/Edge/Firefox only: scroll down a little."),
