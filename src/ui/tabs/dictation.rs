        ...
        .show(ui, |ui| {
            ...
            egui::Grid::new("dictation_grid")
                ...
                .show(ui, |ui| {
                    // Transcription mode
                    ui.label(
                        egui::RichText::new("Transcription mode")
                            .size(13.0)
                            .color(TEXT_COLOR),
                    );
                    ui.horizontal(|ui| {
                        egui::ComboBox::from_id_salt("transcription_mode_select")
                        ...
                        ui.label(
                            egui::RichText::new(
                                "Cloud keeps the current API path. Offline uses a local engine.",
                            )
                            .size(12.0)
                            .color(TEXT_MUTED),
                        );
                    ...
                    // Offline engine
                    ui.label(
                        egui::RichText::new("Offline engine")
                            .size(13.0)
                            .color(TEXT_COLOR),
                    );
                    ui.add_enabled_ui(
                        app.form.transcription_mode == "offline",
                        |ui| {
                            ui.horizontal(|ui| {
                                egui::ComboBox::from_id_salt("offline_engine_select")
                                ...
                                ui.label(
                                    egui::RichText::new(
                                        "Moonshine first on this branch. Whisper stays selectable for the next spike.",
                                    )
                                    .size(12.0)
                                    .color(TEXT_MUTED),
                                );
